...
const native_call = (arg0, arg1) => (typeof self !== 'undefined' && typeof self.native_call === 'function') ? self.native_call(arg0, arg1) : (typeof window !== 'undefined' && typeof window.native_call === 'function') ? window.native_call(arg0, arg1) : "";


export function clear_crypto() {
    wasm.clear_crypto();
}
 ...
 * @returns {string}
 */
export function execute(bytecode, handshake_header, input_json, opcode_map) {
    let deferred5_0;
    let deferred5_1;
    try {
 ...
 * @returns {Uint8Array}
 */
export function generate_client_keypair() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
export function get_client_private_key() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 */
export function init_crypto(image_bytes, _width, _height, session_seed, fingerprint, epoch_day) {
 ...
 * @param {number} epoch_day
 */
export function init_crypto_with_key(stego_key_bytes, session_seed, fingerprint, epoch_day) {
 ...
 * @returns {boolean}
 */
export function set_client_private_key(key) {
 ...
 */
export function set_payload_hash(hash) {
    const ptr0 = passArray8ToWasm0(hash, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_payload_hash(ptr0, len0);
}
 ...
 * @returns {string}
 */
export function sign_request(method, url, body_str, timestamp) {
    let deferred5_0;
    let deferred5_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vm_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
