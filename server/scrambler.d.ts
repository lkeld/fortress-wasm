 ...
 */
export declare function generateHandshake(clientPublicKey: Uint8Array | Buffer, nonceStore: NonceStore): Promise<{
 ...
 */
export declare function scrambleSessionPayload(fvbcPath: string, originalMapPath: string, clientPublicKeyOrSessionKey: Uint8Array | Buffer | undefined, nonceStore: NonceStore): Promise<{
    payload: Uint8Array;
    newMap: number[];
    pngBuffer: Buffer;
