...
impl Vm {
    ...
    // See Pushan: Trace-Free Deobfuscation of Virtualization-Obfuscated Binaries, arxiv.org/abs/2603.18355.
    ...
    pub fn run(&mut self) -> Result<Value, VmError> {
        ...
        loop {
            ...
            // Decentralizing the monolithic match block into tiered sub-dispatchers.
